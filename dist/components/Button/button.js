...
var Button = function (props) {
    var _a;
    var btnType = props.btnType, disabled = props.disabled, className = props.className, // user custom class
    size = props.size, children = props.children, href = props.href, restprops = __rest(props, ["btnType", "disabled", "className", "size", "children", "href"]);
