...
export var AutoComplete = function (props) {
    ...
    var handleSelect = function (item, selectCallback) {
    ...
    var generateDropdown = function () {
        return (React.createElement(Transition, { in: showDropdown || loading, animation: "zoom-in-top", timeout: 100, onExited: function () { setSugestions([]); } },
